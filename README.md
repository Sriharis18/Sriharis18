...
**🛍️ Stylekart** — E-commerce website for a sarees & dresses business.
*React · Node.js · MySQL*

**📊 Online Shopping Behaviour Analysis** — Data mining platform for customer behaviour analysis.
*Python · Flask · Pandas · MySQL*

**🏫 College Website** — Responsive college website with dynamic content.
...
> Learn continuously. Build meaningful projects. Grow as a software developer.
